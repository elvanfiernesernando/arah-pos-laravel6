    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="https://pos.arahmelangkah.com"><img src="{{ asset('images/logoarah/logo-arah-pos.svg') }}" class="mr-2" alt="Arah POS Logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="https://pos.arahmelangkah.com"><img src="{{ asset('images/logoarah/logo-arah-pos-mini.svg') }}" alt="Arah POS Logo" /></a>
            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                            ...
                            <a class="dropdown-item preview-item">
                                ...
                                <div class="preview-item-content">
                                    <h6 class="preview-subject font-weight-normal">Settings</h6>1
                                    <p class="font-weight-light small-text mb-0 text-muted">
                                        Private message
                                    </p>
                                </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <!-- right-sidebar START -->
            <!-- right-sidebar ini di trigger pada bagian navbar diatas-->
